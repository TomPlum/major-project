 ...
 * @version 2.1.4
 */
public class RobotObserver2 {
    private static boolean isOpen = false;

    private static volatile RobotObserver2 single_instance = null;
    private static final Object mutex = new Object();

    private RobotObserver2() {
        startObserving();
    }

    public static synchronized RobotObserver2 getInstance() {
        RobotObserver2 result = single_instance;
        if (result == null) {
            synchronized (mutex) {
                result = single_instance;
                if (result == null) {
                    single_instance = result = new RobotObserver2();
                }
            }
        }
        return result;
    ...
    private JLabel rotateGunOne, rotateGunDirectionOne, rotateScannerOne, rotateScannerDirectionOne;
    ...
    private JTextField numberOfTweetsOneField, userOneField, currentTweetOneField;
    ...
    private JTextField rotateOneField, rotateDirectionOneField, rotateGunOneField, rotateGunDirectionOneField, rotateScannerOneField, rotateScannerDirectionOneField;
    ...
    public void setRotateScannerOne(int rotate) {
        SwingUtilities.invokeLater(() -> rotateScannerOneField.setText(String.valueOf(rotate)));
    }

    public void setRotateScannerDirectionOne(int direction) {
        SwingUtilities.invokeLater(() -> {
            if (direction == 1) {
    ...
    public void main(String[] args) {
        RobotObserver2 ro = new RobotObserver2();
