        ...
        CompletableFuture<Void> future = CompletableFuture.supplyAsync(() -> {
            ...
            while (notExceededRateLimit) {
                try {
                    ...
                    //Using >= as sometimes it downloads slightly more that 3200 as the number on the page differs.
            ...
            //Trim ArrayList if necessary
            if (statuses.size() > 3200) {
                System.out.println("Oops! There were " + statuses.size() + " Statuses. Trimming the excess " + (statuses.size() - 3200));
